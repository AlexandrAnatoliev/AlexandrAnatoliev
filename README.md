...
## telegramBot4
#### БОТ, ВЕДУЩИЙ TELEGRAM-КАНАЛ С АНЕКДОТАМИ. Бот получает список анекдотов из файла и каждый час постит в канал один из этих анекдотов.
...
## pythonProject3
#### БОТ, ВЕДУЩИЙ TELEGRAM-КАНАЛ С АНЕКДОТАМИ. По нажатию кнопки бот присылает случайный анекдот в личку сообщение.
